...
\vspace{10 mm} \large Frankfurt, Hochschule für Musik
}
...
\fancyhead{}
\fancyhead[C]{\small RISM -\ Frankfurt, Hochschule für Musik}
...
\newline \includesvg[width=225pt]{2-1}%
...
\newline \includesvg[width=225pt]{3-1}%
...
\newline \includesvg[width=225pt]{4-1}%
...
\newline \includesvg[width=225pt]{5-1}%
...
\newline \includesvg[width=225pt]{6-1}%
...
\newline \includesvg[width=225pt]{7-1}%
...
\newline \includesvg[width=225pt]{8-1}%
...
\newline \includesvg[width=225pt]{9-1}%
...
\newline \includesvg[width=225pt]{10-1}%
...
\newline \includesvg[width=225pt]{11-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "39"
...
\newline \includesvg[width=225pt]{12-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 12-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-2.code; fi } 
\newline \includesvg[width=225pt]{12-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 12-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-3.code; fi } 
\newline \includesvg[width=225pt]{12-3}%
...
@data:{8'AABB}{''CC}4'G{8AAEE}{GG}4C{8''CCDD}{EE}4'B
\end{filecontents*}
\commandline{ if [ ! -f 12-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-4.code; fi } 
\newline \includesvg[width=225pt]{12-4}%
...
\end{filecontents*}
\commandline{ if [ ! -f 12-5.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-5.code; fi } 
\newline \includesvg[width=225pt]{12-5}%
...
@data:{8'AABB}{''CC}4'G{8AAEE}{GG}4C{8''CCDD}{EE}4'B
\end{filecontents*}
\commandline{ if [ ! -f 12-6.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-6.code; fi } 
\newline \includesvg[width=225pt]{12-6}%
...
\end{filecontents*}
\commandline{ if [ ! -f 12-7.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-7.code; fi } 
\newline \includesvg[width=225pt]{12-7}%
...
\newline \includesvg[width=225pt]{13-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 13-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 13-2.code; fi } 
\newline \includesvg[width=225pt]{13-2}%
...
\newline \includesvg[width=225pt]{14-1}%
...
\newline \includesvg[width=225pt]{15-1}%
...
\newline \includesvg[width=225pt]{16-1}%
...
\par \begin{itshape}[f.105r, between the systems:] Ade du süße Welt\end{itshape} 
...
\newline \includesvg[width=225pt]{17-1}%
...
\par \begin{itshape}[f.105r, between the systems:] Aria\end{itshape} 
...
\newline \includesvg[width=225pt]{18-1}%
...
\newline \includesvg[width=225pt]{19-1}%
...
\newline \includesvg[width=225pt]{20-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 20-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 20-2.code; fi } 
\newline \includesvg[width=225pt]{20-2}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{21-1}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{22-1}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{23-1}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{24-1}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{25-1}%
...
\newline \includesvg[width=225pt]{26-1}%
...
\newline \includesvg[width=225pt]{27-1}%
...
\newline \includesvg[width=225pt]{28-1}%
...
\newline \includesvg[width=225pt]{29-1}%
...
\newline \includesvg[width=225pt]{30-1}%
...
\newline \includesvg[width=225pt]{31-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 32-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 32-1.code; fi } 
\newline \includesvg[width=225pt]{32-1}%
...
\newline \includesvg[width=225pt]{33-1}%
\par Drei Strophen
...
\newline \includesvg[width=225pt]{34-1}%
\par Drei Strophen
...
\newline \includesvg[width=225pt]{35-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 36-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 36-1.code; fi } 
\newline \includesvg[width=225pt]{36-1}%
...
\newline \includesvg[width=225pt]{37-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{38-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{39-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{40-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{41-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{42-1}%
...
\newline \includesvg[width=225pt]{43-1}%
\par Nur die obere Melodiestimme und eine Textzeile ist ausgefüllt, eine Baßsystem ist leer
\par Alte Paginierung auf f.123v vorhanden: "80"
...
\newline \includesvg[width=225pt]{44-1}%
\par Ohne alte Paginierung
...
\newline \includesvg[width=225pt]{45-1}%
...
\newline \includesvg[width=225pt]{46-1}%
...
\newline \includesvg[width=225pt]{47-1}%
\par Nur die obere Melodiestimme und eine Textzeile ist ausgefüllt, eine Baßsystem ist leer
...
\newline \includesvg[width=225pt]{48-1}%
...
\newline \includesvg[width=225pt]{49-1}%
\par Alte Foliierung auf f.31v mit "32"
...
\newline \includesvg[width=225pt]{50-1}%
...
\newline \includesvg[width=225pt]{51-1}%
...
\newline \includesvg[width=225pt]{52-1}%
...
\newline \includesvg[width=225pt]{53-1}%
...
\newline \includesvg[width=225pt]{54-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{55-1}%
\par Alte Foliierung auf f.31v mit "32"
...
\newline \includesvg[width=225pt]{56-1}%
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{57-1}%
\par Sechs Strophen
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\newline \includesvg[width=225pt]{58-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 58-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 58-2.code; fi } 
\newline \includesvg[width=225pt]{58-2}%
...
\newline \includesvg[width=225pt]{59-1}%
...
\newline \includesvg[width=225pt]{60-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 60-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 60-2.code; fi } 
\newline \includesvg[width=225pt]{60-2}%
\par Vier Strophen
...
\newline \includesvg[width=225pt]{61-1}%
\par Unter den beiden Systemen 3 Textstrophen
\par Ohne alte Foliierung
...
\newline \includesvg[width=225pt]{62-1}%
\par Vier Strophen
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\newline \includesvg[width=225pt]{63-1}%
...
\newline \includesvg[width=225pt]{64-1}%
\par Alte Foliierung auf f.30v mit "31"
...
\newline \includesvg[width=225pt]{65-1}%
...
\newline \includesvg[width=225pt]{66-1}%
...
\newline \includesvg[width=225pt]{67-1}%
...
\par \begin{itshape}[f.5r, between the systems:] Deß Heil: Geistes reiche Gnad.\end{itshape} 
...
\newline \includesvg[width=225pt]{68-1}%
...
\newline \includesvg[width=225pt]{69-1}%
...
\newline \includesvg[width=225pt]{70-1}%
\par Sechs Strophen
...
\newline \includesvg[width=225pt]{71-1}%
\par Vier Strophen
...
\newline \includesvg[width=225pt]{72-1}%
...
\newline \includesvg[width=225pt]{73-1}%
...
\newline \includesvg[width=225pt]{74-1}%
...
\newline \includesvg[width=225pt]{75-1}%
...
\newline \includesvg[width=225pt]{76-1}%
\par Alte Foliierung auf f.23v mit "24"
...
\newline \includesvg[width=225pt]{77-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 78-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 78-1.code; fi } 
\newline \includesvg[width=225pt]{78-1}%
\par Alte Foliierung vorhanden: "17"
...
\end{filecontents*}
\commandline{ if [ ! -f 79-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 79-1.code; fi } 
\newline \includesvg[width=225pt]{79-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 80-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 80-1.code; fi } 
\newline \includesvg[width=225pt]{80-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 81-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 81-1.code; fi } 
\newline \includesvg[width=225pt]{81-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 82-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 82-1.code; fi } 
\newline \includesvg[width=225pt]{82-1}%
\par Alte Foliierung auf f.32v mit "33"
...
\end{filecontents*}
\commandline{ if [ ! -f 83-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 83-1.code; fi } 
\newline \includesvg[width=225pt]{83-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 84-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 84-1.code; fi } 
\newline \includesvg[width=225pt]{84-1}%
...
\par 1.1.1  org, \begin{itshape}[without number].\end{itshape}, G-Dur  
...
\end{filecontents*}
\commandline{ if [ ! -f 85-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 85-1.code; fi } 
\newline \includesvg[width=225pt]{85-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 86-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 86-1.code; fi } 
\newline \includesvg[width=225pt]{86-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 87-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 87-1.code; fi } 
\newline \includesvg[width=225pt]{87-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "23"
...
\end{filecontents*}
\commandline{ if [ ! -f 88-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 88-1.code; fi } 
\newline \includesvg[width=225pt]{88-1}%
\par Alte Foliierungen vorhanden: "20" und "21"
...
\end{filecontents*}
\commandline{ if [ ! -f 89-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 89-1.code; fi } 
\newline \includesvg[width=225pt]{89-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 90-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 90-1.code; fi } 
\newline \includesvg[width=225pt]{90-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 91-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 91-1.code; fi } 
\newline \includesvg[width=225pt]{91-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 92-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 92-1.code; fi } 
\newline \includesvg[width=225pt]{92-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 93-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 93-1.code; fi } 
\newline \includesvg[width=225pt]{93-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 94-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 94-1.code; fi } 
\newline \includesvg[width=225pt]{94-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 95-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 95-1.code; fi } 
\newline \includesvg[width=225pt]{95-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 96-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 96-1.code; fi } 
\newline \includesvg[width=225pt]{96-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 97-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 97-1.code; fi } 
\newline \includesvg[width=225pt]{97-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 98-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 98-1.code; fi } 
\newline \includesvg[width=225pt]{98-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 99-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 99-1.code; fi } 
\newline \includesvg[width=225pt]{99-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 100-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 100-1.code; fi } 
\newline \includesvg[width=225pt]{100-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 101-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 101-1.code; fi } 
\newline \includesvg[width=225pt]{101-1}%
\par Alte Foliierung auf f.24v mit "25"
...
\end{filecontents*}
\commandline{ if [ ! -f 102-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 102-1.code; fi } 
\newline \includesvg[width=225pt]{102-1}%
...
\par \begin{itshape}[f.92v, under the system:] Gigue ex G Mol\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 103-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 103-1.code; fi } 
\newline \includesvg[width=225pt]{103-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 104-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 104-1.code; fi } 
\newline \includesvg[width=225pt]{104-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 105-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 105-1.code; fi } 
\newline \includesvg[width=225pt]{105-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "22"
...
\end{filecontents*}
\commandline{ if [ ! -f 106-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 106-1.code; fi } 
\newline \includesvg[width=225pt]{106-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 107-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 107-1.code; fi } 
\newline \includesvg[width=225pt]{107-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 108-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 108-1.code; fi } 
\newline \includesvg[width=225pt]{108-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "23"
...
\end{filecontents*}
\commandline{ if [ ! -f 109-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 109-1.code; fi } 
\newline \includesvg[width=225pt]{109-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 110-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 110-1.code; fi } 
\newline \includesvg[width=225pt]{110-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 111-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 111-1.code; fi } 
\newline \includesvg[width=225pt]{111-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 112-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 112-1.code; fi } 
\newline \includesvg[width=225pt]{112-1}%
\par Unter den beiden Systemen 3 Textstrophen
...
\end{filecontents*}
\commandline{ if [ ! -f 113-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 113-1.code; fi } 
\newline \includesvg[width=225pt]{113-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "22"
...
\end{filecontents*}
\commandline{ if [ ! -f 114-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 114-1.code; fi } 
\newline \includesvg[width=225pt]{114-1}%
\par Alte Foliierung auf f.40v mit "40"
...
\par \begin{itshape}[f.14v, at the tail of the page:] Aliud Melod: ex b. Herr Gott dich loben | alle wir\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 115-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 115-1.code; fi } 
\newline \includesvg[width=225pt]{115-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 116-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 116-1.code; fi } 
\newline \includesvg[width=225pt]{116-1}%
...
@data:2'EGA''C'AA
\end{filecontents*}
\commandline{ if [ ! -f 117-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 117-1.code; fi } 
\newline \includesvg[width=225pt]{117-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 118-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 118-1.code; fi } 
\newline \includesvg[width=225pt]{118-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 119-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 119-1.code; fi } 
\newline \includesvg[width=225pt]{119-1}%
\par Alte Foliierung auf f.71v mit "60"
...
\end{filecontents*}
\commandline{ if [ ! -f 120-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 120-1.code; fi } 
\newline \includesvg[width=225pt]{120-1}%
\par Alte Foliierung auf f.41v mit "41"
...
\end{filecontents*}
\commandline{ if [ ! -f 121-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 121-1.code; fi } 
\newline \includesvg[width=225pt]{121-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "30"
...
\par \begin{itshape}[f.123v, between the systems:] H Jesu lebens Sonne.\end{itshape} 
\par \textcolor{darkblue}{\ding{\numexpr181 + 01}}  1 Stimmen: V and org  (f.123v)\newline Abschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 122-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 122-1.code; fi } 
\newline \includesvg[width=225pt]{122-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 123-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 123-1.code; fi } 
\newline \includesvg[width=225pt]{123-1}%
\par Alte Foliierung auf f.71v mit "60"
...
\end{filecontents*}
\commandline{ if [ ! -f 124-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 124-1.code; fi } 
\newline \includesvg[width=225pt]{124-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 125-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 125-1.code; fi } 
\newline \includesvg[width=225pt]{125-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 126-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 126-1.code; fi } 
\newline \includesvg[width=225pt]{126-1}%
\par Alte Foliierung auf f.35v mit "36"
...
\end{filecontents*}
\commandline{ if [ ! -f 127-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 127-1.code; fi } 
\newline \includesvg[width=225pt]{127-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 128-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 128-1.code; fi } 
\newline \includesvg[width=225pt]{128-1}%
\par Alte Foliierung auf f.28v mit "29"
...
\par \begin{itshape}[f.100r, at the end:] 1713.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 129-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 129-1.code; fi } 
\newline \includesvg[width=225pt]{129-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 130-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 130-1.code; fi } 
\newline \includesvg[width=225pt]{130-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 131-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 131-1.code; fi } 
\newline \includesvg[width=225pt]{131-1}%
\par Zwischen den beiden Systemen nur der Textbeginn wie angegeben
...
\end{filecontents*}
\commandline{ if [ ! -f 132-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 132-1.code; fi } 
\newline \includesvg[width=225pt]{132-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 133-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 133-1.code; fi } 
\newline \includesvg[width=225pt]{133-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 134-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 134-1.code; fi } 
\newline \includesvg[width=225pt]{134-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 135-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 135-1.code; fi } 
\newline \includesvg[width=225pt]{135-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 136-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 136-1.code; fi } 
\newline \includesvg[width=225pt]{136-1}%
\par Alte Foliierung auf f.66v mit "57"
...
\end{filecontents*}
\commandline{ if [ ! -f 137-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 137-1.code; fi } 
\newline \includesvg[width=225pt]{137-1}%
...
\par \begin{itshape}[f.110r, at the tail of the page:] Jesu kom doch selbst zu mir φ\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 138-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 138-1.code; fi } 
\newline \includesvg[width=225pt]{138-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 139-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 139-1.code; fi } 
\newline \includesvg[width=225pt]{139-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 139-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 139-2.code; fi } 
\newline \includesvg[width=225pt]{139-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 140-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 140-1.code; fi } 
\newline \includesvg[width=225pt]{140-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "39"
...
\end{filecontents*}
\commandline{ if [ ! -f 141-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 141-1.code; fi } 
\newline \includesvg[width=225pt]{141-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 142-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 142-1.code; fi } 
\newline \includesvg[width=225pt]{142-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "35"
...
\end{filecontents*}
\commandline{ if [ ! -f 143-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 143-1.code; fi } 
\newline \includesvg[width=225pt]{143-1}%
...
\par 1.1.1  org, \begin{itshape}[without number].\end{itshape}, D-Dur  
...
\end{filecontents*}
\commandline{ if [ ! -f 144-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 144-1.code; fi } 
\newline \includesvg[width=225pt]{144-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 145-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 145-1.code; fi } 
\newline \includesvg[width=225pt]{145-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 146-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 146-1.code; fi } 
\newline \includesvg[width=225pt]{146-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 147-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 147-1.code; fi } 
\newline \includesvg[width=225pt]{147-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 148-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 148-1.code; fi } 
\newline \includesvg[width=225pt]{148-1}%
\par Alte Foliierung vorhanden: "19"
...
\end{filecontents*}
\commandline{ if [ ! -f 149-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 149-1.code; fi } 
\newline \includesvg[width=225pt]{149-1}%
...
\par \begin{itshape}[f.112r, between the systems:] Lebt jemand so wie ich.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 150-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 150-1.code; fi } 
\newline \includesvg[width=225pt]{150-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 151-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 151-1.code; fi } 
\newline \includesvg[width=225pt]{151-1}%
\par Sieben Strophen
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 152-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 152-1.code; fi } 
\newline \includesvg[width=225pt]{152-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 153-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 153-1.code; fi } 
\newline \includesvg[width=225pt]{153-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "23"
...
\end{filecontents*}
\commandline{ if [ ! -f 154-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 154-1.code; fi } 
\newline \includesvg[width=225pt]{154-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 155-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 155-1.code; fi } 
\newline \includesvg[width=225pt]{155-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 156-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 156-1.code; fi } 
\newline \includesvg[width=225pt]{156-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 157-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 157-1.code; fi } 
\newline \includesvg[width=225pt]{157-1}%
\par Vier Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 158-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 158-1.code; fi } 
\newline \includesvg[width=225pt]{158-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "22"
...
\end{filecontents*}
\commandline{ if [ ! -f 159-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 159-1.code; fi } 
\newline \includesvg[width=225pt]{159-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 160-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 160-1.code; fi } 
\newline \includesvg[width=225pt]{160-1}%
\par Zwischen den Systemen nur der Textbeginn wie angegeben
...
\end{filecontents*}
\commandline{ if [ ! -f 161-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 161-1.code; fi } 
\newline \includesvg[width=225pt]{161-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 162-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 162-1.code; fi } 
\newline \includesvg[width=225pt]{162-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 163-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 163-1.code; fi } 
\newline \includesvg[width=225pt]{163-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 164-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 164-1.code; fi } 
\newline \includesvg[width=225pt]{164-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 165-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 165-1.code; fi } 
\newline \includesvg[width=225pt]{165-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 166-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 166-1.code; fi } 
\newline \includesvg[width=225pt]{166-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 166-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 166-2.code; fi } 
\newline \includesvg[width=225pt]{166-2}%
\par Alte Foliierung vorhanden: "19"
...
\end{filecontents*}
\commandline{ if [ ! -f 167-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 167-1.code; fi } 
\newline \includesvg[width=225pt]{167-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 168-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 168-1.code; fi } 
\newline \includesvg[width=225pt]{168-1}%
\par Alte Foliierung auf f.25v mit "26"
...
\end{filecontents*}
\commandline{ if [ ! -f 169-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 169-1.code; fi } 
\newline \includesvg[width=225pt]{169-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 170-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 170-1.code; fi } 
\newline \includesvg[width=225pt]{170-1}%
\par Vier Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 171-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 171-1.code; fi } 
\newline \includesvg[width=225pt]{171-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 172-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 172-1.code; fi } 
\newline \includesvg[width=225pt]{172-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "38"
...
\end{filecontents*}
\commandline{ if [ ! -f 173-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 173-1.code; fi } 
\newline \includesvg[width=225pt]{173-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "38"
...
\end{filecontents*}
\commandline{ if [ ! -f 174-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 174-1.code; fi } 
\newline \includesvg[width=225pt]{174-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 174-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 174-2.code; fi } 
\newline \includesvg[width=225pt]{174-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 175-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 175-1.code; fi } 
\newline \includesvg[width=225pt]{175-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "23"
...
\end{filecontents*}
\commandline{ if [ ! -f 176-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 176-1.code; fi } 
\newline \includesvg[width=225pt]{176-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 177-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 177-1.code; fi } 
\newline \includesvg[width=225pt]{177-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 178-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 178-1.code; fi } 
\newline \includesvg[width=225pt]{178-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 179-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 179-1.code; fi } 
\newline \includesvg[width=225pt]{179-1}%
\par Alte Foliierung auf f.66v mit "57"
...
\end{filecontents*}
\commandline{ if [ ! -f 180-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 180-1.code; fi } 
\newline \includesvg[width=225pt]{180-1}%
\par Zwischen den beiden Systemen nur der Textbeginn wie angegeben
\par Alte Zählung auf f.104r vorhanden: "74"
...
\end{filecontents*}
\commandline{ if [ ! -f 181-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 181-1.code; fi } 
\newline \includesvg[width=225pt]{181-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 181-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 181-2.code; fi } 
\newline \includesvg[width=225pt]{181-2}%
\par Zunächst erklingt die Sinfonia, von der allerdings nur der bc notiert ist, unter dem Notentext des folgenden Chorale arrangements sind 9 Textstrophen aufgeführt
...
\end{filecontents*}
\commandline{ if [ ! -f 182-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 182-1.code; fi } 
\newline \includesvg[width=225pt]{182-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 183-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 183-1.code; fi } 
\newline \includesvg[width=225pt]{183-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 184-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 184-1.code; fi } 
\newline \includesvg[width=225pt]{184-1}%
\par Alte Paginierung vorhanden, f.111v: "89"
...
\end{filecontents*}
\commandline{ if [ ! -f 185-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 185-1.code; fi } 
\newline \includesvg[width=225pt]{185-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 186-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 186-1.code; fi } 
\newline \includesvg[width=225pt]{186-1}%
\par Zwischen den Systemen nur der Textbeginn wie angegeben
...
\end{filecontents*}
\commandline{ if [ ! -f 187-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 187-1.code; fi } 
\newline \includesvg[width=225pt]{187-1}%
\par Alte Foliierung auf f.59v mit "51"
...
\end{filecontents*}
\commandline{ if [ ! -f 188-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 188-1.code; fi } 
\newline \includesvg[width=225pt]{188-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "42"
...
\end{filecontents*}
\commandline{ if [ ! -f 189-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 189-1.code; fi } 
\newline \includesvg[width=225pt]{189-1}%
...
\par \begin{itshape}[f.12v, at the end of the page:] O Vater | Allmäch | tiger G: | Christe\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 190-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 190-1.code; fi } 
\newline \includesvg[width=225pt]{190-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 191-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 191-1.code; fi } 
\newline \includesvg[width=225pt]{191-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 192-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 192-1.code; fi } 
\newline \includesvg[width=225pt]{192-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 193-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 193-1.code; fi } 
\newline \includesvg[width=225pt]{193-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 194-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 194-1.code; fi } 
\newline \includesvg[width=225pt]{194-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 195-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 195-1.code; fi } 
\newline \includesvg[width=225pt]{195-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 196-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 196-1.code; fi } 
\newline \includesvg[width=225pt]{196-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 197-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 197-1.code; fi } 
\newline \includesvg[width=225pt]{197-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 198-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 198-1.code; fi } 
\newline \includesvg[width=225pt]{198-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 199-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 199-1.code; fi } 
\newline \includesvg[width=225pt]{199-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 200-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 200-1.code; fi } 
\newline \includesvg[width=225pt]{200-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 201-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 201-1.code; fi } 
\newline \includesvg[width=225pt]{201-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "42"
...
\par \begin{itshape}[f.104r, between the systems:] Sag w hilfft alle Welt. nach dieser Melodie soll es gesungen werden\end{itshape} 
\par \textcolor{darkblue}{\ding{\numexpr181 + 01}}  1 Stimmen: V and org  (f.104r)\newline Abschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 202-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 202-1.code; fi } 
\newline \includesvg[width=225pt]{202-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 203-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 203-1.code; fi } 
\newline \includesvg[width=225pt]{203-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 204-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 204-1.code; fi } 
\newline \includesvg[width=225pt]{204-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 205-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 205-1.code; fi } 
\newline \includesvg[width=225pt]{205-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 206-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 206-1.code; fi } 
\newline \includesvg[width=225pt]{206-1}%
...
\par \begin{itshape}[f.111v, at the tail of the page:] Seelig sind die in Christo sterben φ\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 207-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 207-1.code; fi } 
\newline \includesvg[width=225pt]{207-1}%
\par Alte Paginierung vorhanden, f.111v: "89"
...
\end{filecontents*}
\commandline{ if [ ! -f 208-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 208-1.code; fi } 
\newline \includesvg[width=225pt]{208-1}%
\par Alte Foliierung auf f.53v mit "47"
...
\end{filecontents*}
\commandline{ if [ ! -f 209-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 209-1.code; fi } 
\newline \includesvg[width=225pt]{209-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 210-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 210-1.code; fi } 
\newline \includesvg[width=225pt]{210-1}%
\par Alte Foliierung auf f.33v mit "34"
...
\end{filecontents*}
\commandline{ if [ ! -f 211-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 211-1.code; fi } 
\newline \includesvg[width=225pt]{211-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 212-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 212-1.code; fi } 
\newline \includesvg[width=225pt]{212-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 213-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 213-1.code; fi } 
\newline \includesvg[width=225pt]{213-1}%
\par Alte Foliierung auf f.35v mit "36"
...
\end{filecontents*}
\commandline{ if [ ! -f 214-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 214-1.code; fi } 
\newline \includesvg[width=225pt]{214-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 215-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 215-1.code; fi } 
\newline \includesvg[width=225pt]{215-1}%
\par Alte Foliierung vorhanden: "4"
...
\end{filecontents*}
\commandline{ if [ ! -f 216-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 216-1.code; fi } 
\newline \includesvg[width=225pt]{216-1}%
\par Alte Foliierung auf f.24v mit "25"
...
\end{filecontents*}
\commandline{ if [ ! -f 217-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 217-1.code; fi } 
\newline \includesvg[width=225pt]{217-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "28"
...
\end{filecontents*}
\commandline{ if [ ! -f 218-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 218-1.code; fi } 
\newline \includesvg[width=225pt]{218-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "28"
...
\end{filecontents*}
\commandline{ if [ ! -f 219-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 219-1.code; fi } 
\newline \includesvg[width=225pt]{219-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 220-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 220-1.code; fi } 
\newline \includesvg[width=225pt]{220-1}%
\par Alte Foliierungen vorhanden: "20" und "21"
...
\par \begin{itshape}[f.21r, at the tail of the page:] Was Gott thut das ist Wohlgethan\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 221-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 221-1.code; fi } 
\newline \includesvg[width=225pt]{221-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 222-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 222-1.code; fi } 
\newline \includesvg[width=225pt]{222-1}%
\par Alte Foliierung auf f.25v mit "26"
...
\end{filecontents*}
\commandline{ if [ ! -f 223-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 223-1.code; fi } 
\newline \includesvg[width=225pt]{223-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 224-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 224-1.code; fi } 
\newline \includesvg[width=225pt]{224-1}%
\par Alte Foliierung auf f.32v mit "33"
...
\end{filecontents*}
\commandline{ if [ ! -f 225-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 225-1.code; fi } 
\newline \includesvg[width=225pt]{225-1}%
\par Alte Foliierung auf f.41v mit "41"
...
\end{filecontents*}
\commandline{ if [ ! -f 226-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 226-1.code; fi } 
\newline \includesvg[width=225pt]{226-1}%
\par Alte Foliierung auf f.28v mit "29"
...
\end{filecontents*}
\commandline{ if [ ! -f 227-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 227-1.code; fi } 
\newline \includesvg[width=225pt]{227-1}%
\par Alte Foliierung auf den gegenüberliegenden Seiten als Aufschlagfoliierung jeweils "56"
...
\end{filecontents*}
\commandline{ if [ ! -f 228-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 228-1.code; fi } 
\newline \includesvg[width=225pt]{228-1}%
\par Alte Foliierung auf f.30v mit "31"
...
\end{filecontents*}
\commandline{ if [ ! -f 229-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 229-1.code; fi } 
\newline \includesvg[width=225pt]{229-1}%
\par Alte Foliierung auf f.26v mit "27"
...
\end{filecontents*}
\commandline{ if [ ! -f 230-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 230-1.code; fi } 
\newline \includesvg[width=225pt]{230-1}%
\par Alte Foliierung auf f.26v mit "27"
...
\end{filecontents*}
\commandline{ if [ ! -f 231-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 231-1.code; fi } 
\newline \includesvg[width=225pt]{231-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 232-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 232-1.code; fi } 
\newline \includesvg[width=225pt]{232-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 233-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 233-1.code; fi } 
\newline \includesvg[width=225pt]{233-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 234-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 234-1.code; fi } 
\newline \includesvg[width=225pt]{234-1}%
\par Alte Foliierung auf f.56v mit "50"
...
\end{filecontents*}
\commandline{ if [ ! -f 235-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 235-1.code; fi } 
\newline \includesvg[width=225pt]{235-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 236-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 236-1.code; fi } 
\newline \includesvg[width=225pt]{236-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 237-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 237-1.code; fi } 
\newline \includesvg[width=225pt]{237-1}%
\par Alte Foliierung auf f.53v mit "47"
...
\end{filecontents*}
\commandline{ if [ ! -f 238-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 238-1.code; fi } 
\newline \includesvg[width=225pt]{238-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 239-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 239-1.code; fi } 
\newline \includesvg[width=225pt]{239-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 240-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 240-1.code; fi } 
\newline \includesvg[width=225pt]{240-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 246-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 246-1.code; fi } 
\newline \includesvg[width=225pt]{246-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 247-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 247-1.code; fi } 
\newline \includesvg[width=225pt]{247-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 248-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 248-1.code; fi } 
\newline \includesvg[width=225pt]{248-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 262-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 262-1.code; fi } 
\newline \includesvg[width=225pt]{262-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 266-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 266-1.code; fi } 
\newline \includesvg[width=225pt]{266-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 267-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 267-1.code; fi } 
\newline \includesvg[width=225pt]{267-1}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 268-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 268-1.code; fi } 
\newline \includesvg[width=225pt]{268-1}%
...
@data:2'A''C'AAAABAGF
\end{filecontents*}
\commandline{ if [ ! -f 268-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 268-2.code; fi } 
\newline \includesvg[width=225pt]{268-2}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 275-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 275-1.code; fi } 
\newline \includesvg[width=225pt]{275-1}%
\par Alte Foliierung auf f.56v mit "50"
...
\end{filecontents*}
\commandline{ if [ ! -f 276-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 276-1.code; fi } 
\newline \includesvg[width=225pt]{276-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 276-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 276-2.code; fi } 
\newline \includesvg[width=225pt]{276-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 292-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 292-1.code; fi } 
\newline \includesvg[width=225pt]{292-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 293-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 293-1.code; fi } 
\newline \includesvg[width=225pt]{293-1}%
\par Acht Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 303-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 303-1.code; fi } 
\newline \includesvg[width=225pt]{303-1}%
\par Neun Strophen
...
\par \begin{itshape}[Umschlag: Œuvres de W. A. Mozart. Concert pour le pianoforte, N$^o$ I]. Concert pour le pianoforte [C], avec accompagnement de 2 violons, alto et basse, flûte, 2 hautbois, 2 bassons, 2 cors, 2 trompettes et timballes, par W. A. Mozart. N$^o$ I\end{itshape} 
\par \textcolor{darkblue}{\ding{\numexpr181 + 01}}  Stimme(s)\newline Musikdruck
\par Gesamtausgabe\newline Breitkopf \& Härtel  (pbl)
...
\par \begin{itshape}[label on cover, stamped:] ORATORIO | LA PASSIONE | DI GESU CHRISTO | [title page:] Partitura | Oratorio | La | Passione di Gesu Christo | Del Sig$^r$$^e$ Ferdinando Paer.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 308-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-1.code; fi } 
\newline \includesvg[width=225pt]{308-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 308-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-2.code; fi } 
\newline \includesvg[width=225pt]{308-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 308-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-3.code; fi } 
\newline \includesvg[width=225pt]{308-3}%
...
\end{filecontents*}
\commandline{ if [ ! -f 308-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-4.code; fi } 
\newline \includesvg[width=225pt]{308-4}%
...
@data:8''C/qb'BAA4-
\end{filecontents*}
\commandline{ if [ ! -f 308-5.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-5.code; fi } 
\newline \includesvg[width=225pt]{308-5}%
...
@data:8-/4-'DqC8,BB4-/
\end{filecontents*}
\commandline{ if [ ! -f 308-6.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-6.code; fi } 
\newline \includesvg[width=225pt]{308-6}%
...
\end{filecontents*}
\commandline{ if [ ! -f 308-7.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 308-7.code; fi } 
\newline \includesvg[width=225pt]{308-7}%
...
\end{filecontents*}
\commandline{ if [ ! -f 309-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 309-1.code; fi } 
\newline \includesvg[width=225pt]{309-1}%
\par Zwei Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 310-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 310-1.code; fi } 
\newline \includesvg[width=225pt]{310-1}%
\par Vier Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 311-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 311-1.code; fi } 
\newline \includesvg[width=225pt]{311-1}%
\par Sechs Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 326-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 326-1.code; fi } 
\newline \includesvg[width=225pt]{326-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 326-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 326-2.code; fi } 
\newline \includesvg[width=225pt]{326-2}%
\par Ohne alte Foliierung
...
\end{filecontents*}
\commandline{ if [ ! -f 327-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 327-1.code; fi } 
\newline \includesvg[width=225pt]{327-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 327-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 327-2.code; fi } 
\newline \includesvg[width=225pt]{327-2}%
...
\end{filecontents*}
\commandline{ if [ ! -f 334-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 334-1.code; fi } 
\newline \includesvg[width=225pt]{334-1}%
\par Vier Strophen
...
\end{filecontents*}
\commandline{ if [ ! -f 335-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 335-1.code; fi } 
\newline \includesvg[width=225pt]{335-1}%
\par Ohne alte Paginierung
...
\end{filecontents*}
\commandline{ if [ ! -f 336-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 336-1.code; fi } 
\newline \includesvg[width=225pt]{336-1}%
...
\par \begin{itshape}[identisch mit den Duos GiaV. 53-55]. Trois trios [h, D, B] pour deux violons et basse ... œuvre 18.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 343-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 343-1.code; fi } 
\newline \includesvg[width=225pt]{343-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 344-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 344-1.code; fi } 
\newline \includesvg[width=225pt]{344-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 345-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 345-1.code; fi } 
\newline \includesvg[width=225pt]{345-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 346-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 346-1.code; fi } 
\newline \includesvg[width=225pt]{346-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 347-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 347-1.code; fi } 
\newline \includesvg[width=225pt]{347-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 348-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 348-1.code; fi } 
\newline \includesvg[width=225pt]{348-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 349-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 349-1.code; fi } 
\newline \includesvg[width=225pt]{349-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 350-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 350-1.code; fi } 
\newline \includesvg[width=225pt]{350-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 351-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 351-1.code; fi } 
\newline \includesvg[width=225pt]{351-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 352-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 352-1.code; fi } 
\newline \includesvg[width=225pt]{352-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 353-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 353-1.code; fi } 
\newline \includesvg[width=225pt]{353-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 354-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 354-1.code; fi } 
\newline \includesvg[width=225pt]{354-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 355-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 355-1.code; fi } 
\newline \includesvg[width=225pt]{355-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 356-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 356-1.code; fi } 
\newline \includesvg[width=225pt]{356-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 357-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 357-1.code; fi } 
\newline \includesvg[width=225pt]{357-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\par \begin{itshape}[f.5v, mandora 1, at left:] Andante | gratioso | [left before the accolade:] 2.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 358-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 358-1.code; fi } 
\newline \includesvg[width=225pt]{358-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 359-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 359-1.code; fi } 
\newline \includesvg[width=225pt]{359-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 360-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 360-1.code; fi } 
\newline \includesvg[width=225pt]{360-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 361-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 361-1.code; fi } 
\newline \includesvg[width=225pt]{361-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 362-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 362-1.code; fi } 
\newline \includesvg[width=225pt]{362-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 363-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 363-1.code; fi } 
\newline \includesvg[width=225pt]{363-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 364-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 364-1.code; fi } 
\newline \includesvg[width=225pt]{364-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 365-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 365-1.code; fi } 
\newline \includesvg[width=225pt]{365-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 366-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 366-1.code; fi } 
\newline \includesvg[width=225pt]{366-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 367-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 367-1.code; fi } 
\newline \includesvg[width=225pt]{367-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 368-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 368-1.code; fi } 
\newline \includesvg[width=225pt]{368-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 369-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 369-1.code; fi } 
\newline \includesvg[width=225pt]{369-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 370-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 370-1.code; fi } 
\newline \includesvg[width=225pt]{370-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 371-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 371-1.code; fi } 
\newline \includesvg[width=225pt]{371-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 372-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 372-1.code; fi } 
\newline \includesvg[width=225pt]{372-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 373-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 373-1.code; fi } 
\newline \includesvg[width=225pt]{373-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 374-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 374-1.code; fi } 
\newline \includesvg[width=225pt]{374-1}%
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 375-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 375-1.code; fi } 
\newline \includesvg[width=225pt]{375-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 376-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 376-1.code; fi } 
\newline \includesvg[width=225pt]{376-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 377-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 377-1.code; fi } 
\newline \includesvg[width=225pt]{377-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 378-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 378-1.code; fi } 
\newline \includesvg[width=225pt]{378-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 379-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 379-1.code; fi } 
\newline \includesvg[width=225pt]{379-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 380-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 380-1.code; fi } 
\newline \includesvg[width=225pt]{380-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 381-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 381-1.code; fi } 
\newline \includesvg[width=225pt]{381-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 382-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 382-1.code; fi } 
\newline \includesvg[width=225pt]{382-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 383-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 383-1.code; fi } 
\newline \includesvg[width=225pt]{383-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 384-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 384-1.code; fi } 
\newline \includesvg[width=225pt]{384-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 385-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 385-1.code; fi } 
\newline \includesvg[width=225pt]{385-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 386-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 386-1.code; fi } 
\newline \includesvg[width=225pt]{386-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 387-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 387-1.code; fi } 
\newline \includesvg[width=225pt]{387-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 388-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 388-1.code; fi } 
\newline \includesvg[width=225pt]{388-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 389-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 389-1.code; fi } 
\newline \includesvg[width=225pt]{389-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 390-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 390-1.code; fi } 
\newline \includesvg[width=225pt]{390-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 391-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 391-1.code; fi } 
\newline \includesvg[width=225pt]{391-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 392-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 392-1.code; fi } 
\newline \includesvg[width=225pt]{392-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 393-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 393-1.code; fi } 
\newline \includesvg[width=225pt]{393-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 394-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 394-1.code; fi } 
\newline \includesvg[width=225pt]{394-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 395-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 395-1.code; fi } 
\newline \includesvg[width=225pt]{395-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 396-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 396-1.code; fi } 
\newline \includesvg[width=225pt]{396-1}%
\par Drei Strophen
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 397-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 397-1.code; fi } 
\newline \includesvg[width=225pt]{397-1}%
\par Eine Strophe
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\par \begin{itshape}[f.2v, mandora 1, heading:] Ouverture | [left before the accolade:] Nro 1\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 398-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 398-1.code; fi } 
\newline \includesvg[width=225pt]{398-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 399-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 399-1.code; fi } 
\newline \includesvg[width=225pt]{399-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 400-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 400-1.code; fi } 
\newline \includesvg[width=225pt]{400-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 401-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 401-1.code; fi } 
\newline \includesvg[width=225pt]{401-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 402-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 402-1.code; fi } 
\newline \includesvg[width=225pt]{402-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 403-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 403-1.code; fi } 
\newline \includesvg[width=225pt]{403-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 404-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 404-1.code; fi } 
\newline \includesvg[width=225pt]{404-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 405-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 405-1.code; fi } 
\newline \includesvg[width=225pt]{405-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 406-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 406-1.code; fi } 
\newline \includesvg[width=225pt]{406-1}%
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 407-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 407-1.code; fi } 
\newline \includesvg[width=225pt]{407-1}%
\par Der Schreiber ist der selbe wie der 70 Divertimenti in der gleichen Handschrift
...
\end{filecontents*}
\commandline{ if [ ! -f 408-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 408-1.code; fi } 
\newline \includesvg[width=225pt]{408-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\par \begin{itshape}[f.6v, mandora 1, at left:] Scherzando | [left before the accolade:] 3.\end{itshape} 
...
\end{filecontents*}
\commandline{ if [ ! -f 409-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 409-1.code; fi } 
\newline \includesvg[width=225pt]{409-1}%
...
\end{filecontents*}
\commandline{ if [ ! -f 410-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 410-1.code; fi } 
\newline \includesvg[width=225pt]{410-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 411-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 411-1.code; fi } 
\newline \includesvg[width=225pt]{411-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 412-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 412-1.code; fi } 
\newline \includesvg[width=225pt]{412-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 413-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 413-1.code; fi } 
\newline \includesvg[width=225pt]{413-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 414-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 414-1.code; fi } 
\newline \includesvg[width=225pt]{414-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 415-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 415-1.code; fi } 
\newline \includesvg[width=225pt]{415-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 416-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 416-1.code; fi } 
\newline \includesvg[width=225pt]{416-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
...
\end{filecontents*}
\commandline{ if [ ! -f 417-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 417-1.code; fi } 
\newline \includesvg[width=225pt]{417-1}%
\par Der Band mit der mandora 2 befindet sich in D Eu mit der Signatur Esl VIII 403
\par RISM-ID: 455011063\newline D-Fh  Ms 002\newline $\rightarrow$ In Sammlung 419 (455008345)
      
\par \vspace{16pt} \textcolor{darkblue}{\textbf{Sammlung}}\hfillplus{\textbf{418}}\newline 239 Pieces
\par \begin{itshape}[title page:] Georgius Michael | Oster nd. mag. ind. | in Harraß. | 1684 d. 17. Jun.\end{itshape} 
...
\par \vspace{16pt} \textcolor{darkblue}{\textbf{Sammlung}}\hfillplus{\textbf{419}}\newline 95 Instrumental pieces
\par \begin{itshape}[title page:] LXXII | Divertimente | a | Due Mandore | Mandora I | [at the tail, at right:] di Zinck\end{itshape} 
