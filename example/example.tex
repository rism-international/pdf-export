...
\ShellEscape{ if [ ! -f 1-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 1-1.code; fi } 
...
\ShellEscape{ if [ ! -f 2-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 2-1.code; fi } 
...
\ShellEscape{ if [ ! -f 3-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 3-1.code; fi } 
...
\ShellEscape{ if [ ! -f 4-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 4-1.code; fi } 
...
\ShellEscape{ if [ ! -f 5-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 5-1.code; fi } 
...
\ShellEscape{ if [ ! -f 6-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 6-1.code; fi } 
...
\ShellEscape{ if [ ! -f 7-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 7-1.code; fi } 
...
\ShellEscape{ if [ ! -f 8-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 8-1.code; fi } 
...
\ShellEscape{ if [ ! -f 9-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 9-1.code; fi } 
...
\ShellEscape{ if [ ! -f 10-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 10-1.code; fi } 
...
\ShellEscape{ if [ ! -f 11-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 11-1.code; fi } 
...
\ShellEscape{ if [ ! -f 12-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 12-1.code; fi } 
...
\ShellEscape{ if [ ! -f 13-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 13-1.code; fi } 
...
\ShellEscape{ if [ ! -f 14-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 14-1.code; fi } 
...
\ShellEscape{ if [ ! -f 15-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 15-1.code; fi } 
...
\ShellEscape{ if [ ! -f 15-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 15-2.code; fi } 
...
\ShellEscape{ if [ ! -f 16-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 16-1.code; fi } 
...
\ShellEscape{ if [ ! -f 16-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 16-2.code; fi } 
...
\ShellEscape{ if [ ! -f 17-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 17-1.code; fi } 
...
\ShellEscape{ if [ ! -f 18-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 18-1.code; fi } 
...
\ShellEscape{ if [ ! -f 19-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 19-1.code; fi } 
...
\ShellEscape{ if [ ! -f 20-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 20-1.code; fi } 
...
\ShellEscape{ if [ ! -f 21-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-1.code; fi } 
...
\ShellEscape{ if [ ! -f 21-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-2.code; fi } 
...
\ShellEscape{ if [ ! -f 21-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-3.code; fi } 
...
\ShellEscape{ if [ ! -f 21-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-4.code; fi } 
...
\ShellEscape{ if [ ! -f 21-5.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-5.code; fi } 
...
\ShellEscape{ if [ ! -f 21-6.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 21-6.code; fi } 
...
\ShellEscape{ if [ ! -f 22-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-1.code; fi } 
...
\ShellEscape{ if [ ! -f 22-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-2.code; fi } 
...
\ShellEscape{ if [ ! -f 22-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-3.code; fi } 
...
\ShellEscape{ if [ ! -f 22-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-4.code; fi } 
...
\ShellEscape{ if [ ! -f 22-5.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-5.code; fi } 
...
\ShellEscape{ if [ ! -f 22-6.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 22-6.code; fi } 
...
\ShellEscape{ if [ ! -f 23-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 23-1.code; fi } 
...
\ShellEscape{ if [ ! -f 23-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 23-2.code; fi } 
...
\ShellEscape{ if [ ! -f 24-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 24-1.code; fi } 
...
\ShellEscape{ if [ ! -f 24-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 24-2.code; fi } 
...
\ShellEscape{ if [ ! -f 24-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 24-3.code; fi } 
...
\ShellEscape{ if [ ! -f 25-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-1.code; fi } 
...
\ShellEscape{ if [ ! -f 25-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-2.code; fi } 
...
\ShellEscape{ if [ ! -f 25-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-3.code; fi } 
...
\ShellEscape{ if [ ! -f 25-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-4.code; fi } 
...
\ShellEscape{ if [ ! -f 25-5.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-5.code; fi } 
...
\ShellEscape{ if [ ! -f 25-6.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-6.code; fi } 
...
\ShellEscape{ if [ ! -f 25-7.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-7.code; fi } 
...
\ShellEscape{ if [ ! -f 25-8.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-8.code; fi } 
...
\ShellEscape{ if [ ! -f 25-9.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-9.code; fi } 
...
\ShellEscape{ if [ ! -f 25-10.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 25-10.code; fi } 
...
\ShellEscape{ if [ ! -f 26-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 26-1.code; fi } 
...
\ShellEscape{ if [ ! -f 26-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 26-2.code; fi } 
...
\ShellEscape{ if [ ! -f 27-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 27-1.code; fi } 
...
\ShellEscape{ if [ ! -f 27-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 27-2.code; fi } 
...
\ShellEscape{ if [ ! -f 28-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 28-1.code; fi } 
...
\ShellEscape{ if [ ! -f 28-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 28-2.code; fi } 
...
\ShellEscape{ if [ ! -f 29-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 29-1.code; fi } 
...
\ShellEscape{ if [ ! -f 29-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 29-2.code; fi } 
...
\ShellEscape{ if [ ! -f 30-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 30-1.code; fi } 
...
\ShellEscape{ if [ ! -f 30-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 30-2.code; fi } 
...
\ShellEscape{ if [ ! -f 31-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 31-1.code; fi } 
...
\ShellEscape{ if [ ! -f 33-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 33-1.code; fi } 
...
\ShellEscape{ if [ ! -f 33-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 33-2.code; fi } 
...
\ShellEscape{ if [ ! -f 33-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 33-3.code; fi } 
...
\ShellEscape{ if [ ! -f 33-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 33-4.code; fi } 
...
\ShellEscape{ if [ ! -f 34-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 34-1.code; fi } 
...
\ShellEscape{ if [ ! -f 34-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 34-2.code; fi } 
...
\ShellEscape{ if [ ! -f 34-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 34-3.code; fi } 
...
\ShellEscape{ if [ ! -f 34-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 34-4.code; fi } 
...
\ShellEscape{ if [ ! -f 35-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 35-1.code; fi } 
...
\ShellEscape{ if [ ! -f 35-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 35-2.code; fi } 
...
\ShellEscape{ if [ ! -f 35-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 35-3.code; fi } 
...
\ShellEscape{ if [ ! -f 35-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 35-4.code; fi } 
...
\ShellEscape{ if [ ! -f 37-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 37-1.code; fi } 
...
\ShellEscape{ if [ ! -f 38-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 38-1.code; fi } 
...
\ShellEscape{ if [ ! -f 38-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 38-2.code; fi } 
...
\ShellEscape{ if [ ! -f 39-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 39-1.code; fi } 
...
\ShellEscape{ if [ ! -f 39-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 39-2.code; fi } 
...
\ShellEscape{ if [ ! -f 40-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 40-1.code; fi } 
...
\ShellEscape{ if [ ! -f 40-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 40-2.code; fi } 
...
\ShellEscape{ if [ ! -f 40-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 40-3.code; fi } 
...
\ShellEscape{ if [ ! -f 41-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 41-1.code; fi } 
...
\ShellEscape{ if [ ! -f 41-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 41-2.code; fi } 
...
\ShellEscape{ if [ ! -f 42-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 42-1.code; fi } 
...
\ShellEscape{ if [ ! -f 43-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 43-1.code; fi } 
...
\ShellEscape{ if [ ! -f 44-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 44-1.code; fi } 
...
\ShellEscape{ if [ ! -f 44-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 44-2.code; fi } 
...
\ShellEscape{ if [ ! -f 44-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 44-3.code; fi } 
...
\ShellEscape{ if [ ! -f 44-4.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 44-4.code; fi } 
...
\ShellEscape{ if [ ! -f 45-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 45-1.code; fi } 
...
\ShellEscape{ if [ ! -f 45-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 45-2.code; fi } 
...
\ShellEscape{ if [ ! -f 46-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 46-1.code; fi } 
...
\ShellEscape{ if [ ! -f 46-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 46-2.code; fi } 
...
\ShellEscape{ if [ ! -f 47-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 47-1.code; fi } 
...
\ShellEscape{ if [ ! -f 47-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 47-2.code; fi } 
...
\ShellEscape{ if [ ! -f 47-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 47-3.code; fi } 
...
\ShellEscape{ if [ ! -f 48-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 48-1.code; fi } 
...
\ShellEscape{ if [ ! -f 48-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 48-2.code; fi } 
...
\ShellEscape{ if [ ! -f 49-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 49-1.code; fi } 
...
\ShellEscape{ if [ ! -f 49-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 49-2.code; fi } 
...
\ShellEscape{ if [ ! -f 50-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 50-1.code; fi } 
...
\ShellEscape{ if [ ! -f 50-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 50-2.code; fi } 
...
\ShellEscape{ if [ ! -f 51-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 51-1.code; fi } 
...
\ShellEscape{ if [ ! -f 51-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 51-2.code; fi } 
...
\ShellEscape{ if [ ! -f 51-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 51-3.code; fi } 
...
\ShellEscape{ if [ ! -f 52-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 52-1.code; fi } 
...
\ShellEscape{ if [ ! -f 52-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 52-2.code; fi } 
...
\ShellEscape{ if [ ! -f 53-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 53-1.code; fi } 
...
\ShellEscape{ if [ ! -f 54-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 54-1.code; fi } 
...
\ShellEscape{ if [ ! -f 55-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 55-1.code; fi } 
...
\ShellEscape{ if [ ! -f 56-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 56-1.code; fi } 
...
\ShellEscape{ if [ ! -f 57-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 57-1.code; fi } 
...
\ShellEscape{ if [ ! -f 58-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 58-1.code; fi } 
...
\ShellEscape{ if [ ! -f 59-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 59-1.code; fi } 
...
\ShellEscape{ if [ ! -f 60-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 60-1.code; fi } 
...
\ShellEscape{ if [ ! -f 61-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 61-1.code; fi } 
...
\ShellEscape{ if [ ! -f 62-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 62-1.code; fi } 
...
\ShellEscape{ if [ ! -f 63-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 63-1.code; fi } 
...
\ShellEscape{ if [ ! -f 63-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 63-2.code; fi } 
...
\ShellEscape{ if [ ! -f 64-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 64-1.code; fi } 
...
\ShellEscape{ if [ ! -f 64-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 64-2.code; fi } 
...
\ShellEscape{ if [ ! -f 64-3.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 64-3.code; fi } 
...
\ShellEscape{ if [ ! -f 65-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 65-1.code; fi } 
...
\ShellEscape{ if [ ! -f 66-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 66-1.code; fi } 
...
\ShellEscape{ if [ ! -f 66-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 66-2.code; fi } 
...
\ShellEscape{ if [ ! -f 67-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 67-1.code; fi } 
...
\ShellEscape{ if [ ! -f 67-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 67-2.code; fi } 
...
\ShellEscape{ if [ ! -f 68-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 68-1.code; fi } 
...
\ShellEscape{ if [ ! -f 69-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 69-1.code; fi } 
...
\ShellEscape{ if [ ! -f 69-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 69-2.code; fi } 
...
\ShellEscape{ if [ ! -f 70-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 70-1.code; fi } 
...
\ShellEscape{ if [ ! -f 71-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 71-1.code; fi } 
...
\ShellEscape{ if [ ! -f 72-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 72-1.code; fi } 
...
\ShellEscape{ if [ ! -f 72-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 72-2.code; fi } 
...
\ShellEscape{ if [ ! -f 73-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 73-1.code; fi } 
...
\ShellEscape{ if [ ! -f 74-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 74-1.code; fi } 
...
\ShellEscape{ if [ ! -f 74-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 74-2.code; fi } 
...
\ShellEscape{ if [ ! -f 75-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 75-1.code; fi } 
...
\ShellEscape{ if [ ! -f 76-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 76-1.code; fi } 
...
\ShellEscape{ if [ ! -f 77-1.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 77-1.code; fi } 
...
\ShellEscape{ if [ ! -f 77-2.svg ]; then verovio --spacing-non-linear=0.54 -w 1500 --spacing-system=0.5 --adjust-page-height -b 0 77-2.code; fi } 
...
\fancyhead[C]{\small RISM -\ Kunstsammlungen der Veste Coburg}
  ...
  \textbf{MH}\hspace{10pt}
  Johann Michael Haydn (1737-1806). A chronological thematic catalogue of his works, in: Thematic catalogue series, vol. 17, Stuyvesant (NY) 1993 \newline 


  \textbf{NBA}\hspace{10pt}
  Johann Sebastian Bach: Neue Ausgabe sämtlicher Werke, Kassel, Basel 1954- \newline 


  \textbf{NMA}\hspace{10pt}
  Wolfgang Amadeus Mozart: Neue Ausgabe sämtlicher Werke (ed. Internationale Stiftung Mozarteum Salzburg), Kassel etc. 1955- \newline 


  \textbf{SaladinL 1948}\hspace{10pt}
  Saladin, Josef Anton: Die Musikpflege am Stift St. Leodegar in Luzern, Stans 1948 \newline 


  \textbf{Schmidt-GörgB 1961}\hspace{10pt}
  L. van Beethoven: Werke: Neue Ausgabe sämtlicher Werke, München, Duisburg 1961- \newline 


  \textbf{SchmidtB 1969}\hspace{10pt}
  Schmidt, Hans: Verzeichnis der Skizzen Beethovens, in: Beethoven-Jahrbuch, 6 (1965/68, 1969), p.7-128, Bonn  \newline 


  \textbf{SpiF}\hspace{10pt}
  Spitta, Philipp: Musikalische Werke Friedrichs des Grossen, Leipzig 1889 \newline 


  \textbf{TysonC 1975}\hspace{10pt}
  Tyson, Alan: La Clemenza di Tito and its chronology, in: Musical Times, 116 (1975), p.221-227 \newline 


  \textbf{WotG}\hspace{10pt}
  Wotquenne, Alfred: Catalogue thématique des œuvres de Chr. W. v. Gluck (Neuauflage), Hildesheim 1967 \newline 


  \textbf{ZirnbauerB 1950}\hspace{10pt}
  Zirnbauer, Heinz: Coburger Urfassung der 151. Kantate Johann Sebastian Bachs, in: Coburg in Bayern: Festschrift der Stadt Coburg, (1950), p.56-57 \newline 
